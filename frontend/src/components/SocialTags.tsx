...
function Icon({ kind }: { kind: 'linkedin' | 'mail' | 'github' }) {
  if (kind === 'mail') {
    return (
  ...
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
      <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5ZM.5 8.5H4.5V23.5H.5V8.5ZM8.5 8.5H12.3V10.6H12.35C12.88 9.6 14.2 8.55 16.15 8.55 20.2 8.55 21 11.05 21 15.3V23.5H17V16.15C17 14.4 16.95 12.15 14.55 12.15 12.1 12.15 11.75 14.05 11.75 16.05V23.5H7.75V8.5H8.5Z" />
    </svg>
  )
}

export default function SocialTags({ className = '' }: { className?: string }) {
  return (
    <div className={['-mx-4 mt-5', className].join(' ')}>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-150 group-hover:opacity-100">
                <span className="px-2 text-[11px] font-medium tracking-tight">{s.title}</span>
              </div>
            </div>
          </a>
        ))}
